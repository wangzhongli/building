...
import com.e1858.building.BuildConfig;
	...
	private final OnScrollListener	mOnScrollListener	= new OnScrollListener() {
															...
															public void onScrollStateChanged(AbsListView view,
																...
																if (mDelegateOnScrollListener != null) { // delegate
																	mDelegateOnScrollListener.onScrollStateChanged(
																			view, scrollState);
																}
															}
															...
															public void onScroll(AbsListView view,
																...
																if (mDelegateOnScrollListener != null) { // delegate
																	mDelegateOnScrollListener.onScroll(view,
																...
																if (isFirstVisibleItemSection) {
																	...
																	if (sectionView.getTop() == getPaddingTop()) { // view sticks to the top, no need for pinned shadow
																		...
																		ensureShadowForPosition(firstVisibleItem,
																				firstVisibleItem, visibleItemCount);
																	}
