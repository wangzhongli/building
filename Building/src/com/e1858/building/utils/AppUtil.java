...
public class AppUtil {
	...
	public static void dial(Context context, String number) {
		Intent intent = new Intent(Intent.ACTION_DIAL, Uri.parse(new StringBuilder("tel:").append(number.trim())
				.toString()));
		context.startActivity(intent);
	}

	public static void call(Context context, String number) {
		Intent intent = new Intent(Intent.ACTION_CALL, Uri.parse(new StringBuilder("tel:").append(number.trim())
				.toString()));
		context.startActivity(intent);
	}
}
